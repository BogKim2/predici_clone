# Test result: CrossLinkingModels.pdf

이 디렉터리는 `CrossLinkingModels.pdf` 재현 시나리오의 개별 실행 결과입니다.

- 결과: **PASS 1 / FAIL 0 / SKIP 0**
- PDF 커버리지: **1 / 39 (2.56%)**
- 실행 명령: `python main_program2.py`
- 생성 시각(UTC): `2026-07-16T00:50:23.026747+00:00`
...
- [main_program2.py](main_program2.py): `input.json`을 읽어 이 시나리오를 다시 실행
