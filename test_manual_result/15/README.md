# Test result: Predici11 Polymer Tutorial.pdf

이 디렉터리는 `Predici11 Polymer Tutorial.pdf` 재현 시나리오의 개별 실행 결과입니다.

- 결과: **PASS 1 / FAIL 0 / SKIP 0**
- PDF 커버리지: **1 / 39 (2.56%)**
- 실행 명령: `python -m test_manuals --pdf "Predici11 Polymer Tutorial.pdf" --output .\test_manual_result\15`
- 생성 시각(UTC): `2026-07-15T10:34:29.028537+00:00`
