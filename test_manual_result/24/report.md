...
- Generated (UTC): `2026-07-15T10:34:29.046822+00:00`
- Command: `python -m test_manuals --pdf "Predici11_Workshop_November_2016_5. Monte-Carlo_Details.pdf" --output .\test_manual_result\24`
- Environment: Python 3.13.14 / Windows-11-10.0.26200-SP0
- Result: PASS 1 / FAIL 0 / SKIP 0
- PDF coverage: 1 / 39 (2.56%)
- Total duration: 0.000515 seconds

## By feature

| Name | Examples | PDFs | PASS | FAIL | SKIP |
| --- | ---: | ---: | ---: | ---: | ---: |
| montecarlo | 1 | 1 | 1 | 0 | 0 |
