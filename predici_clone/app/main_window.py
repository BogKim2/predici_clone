...
class MainWindow(QMainWindow):
    ...
    def _build_model_builder_tab(self) -> QWidget:
        ...
        self.reaction_pattern_slot_table.setAcceptDrops(True)
        self.reaction_pattern_slot_table.setDragDropMode(QAbstractItemView.InternalMove)
        self.reaction_pattern_slot_table.setDefaultDropAction(Qt.MoveAction)
