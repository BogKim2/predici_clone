...
def script_function_catalog() -> tuple[ScriptFunctionSpec, ...]:
    return (
        ...
        ScriptFunctionSpec("weightedmy", ("moment",), "distribution", "Return a weighted distribution moment if supplied, otherwise the raw moment."),
        ...
        ScriptFunctionSpec("getuxr", ("reactor",), "reactor", "Return a supplied reactor profile value."),
        ScriptFunctionSpec("getkpt", ("parameter", "time"), "parameter", "Return a supplied time-dependent parameter value."),
        ScriptFunctionSpec("getkptp", ("parameter", "time", "position"), "parameter", "Return a supplied time/position parameter value."),
    )
